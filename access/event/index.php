      ...
      <div class="col-md-6 pr-2">
        <div class="container card mt-2 myCard">
          ...
          <ul class="nav nav-pills mb-3 shadow-sm" id="pills-tab" role="tablist">
            <li class="nav-item">
              <a class="nav-link" id="pills_tableHome" data-toggle="pill" href="#pills_home" role="tab" aria-controls="pills_home" aria-selected="true">Event Detail</a>
            </li>
            <li class="nav-item">
          ...
          <div class="tab-content" id="pills-tabContent p-3">
            ...
            <div class="tab-pane fade" id="pills_home" role="tabpanel" aria-labelledby="pills_home">
              <form id="newStudent">
                <div class="row">
  ...
  $(document).ready(function() {
    ...
    $(document).on('submit', '#newStudent', function(event) {
      ...
      if (error == "NO") {
        ...
        $.post("eventSql.php", formData, () => {}, "text").done(function(data) {
          // $.alert(data);
          $(".newId").html(data);
          $("#userId").val(data);
          $("#stdRno").val(data);
