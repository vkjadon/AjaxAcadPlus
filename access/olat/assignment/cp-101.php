...
//	if($thetaP1>180)$thetaP1=$thetaP1-360;
	...
	$pcp[4]=round($tauMax,2);
	$pcp[5]=round($sigma1,2);
	$pcp[6]=round($sigma2,2);
...
// Solution
	if($solution=='Y')
	{
		...
		echo '<tr><td>Maximum Shear Stress </td><td>'.$pcp[4].' MPa</td></tr>';
		echo '<tr><td>Maximum Principal Stress </td><td>'.$pcp[5].' MPa</td></tr>';
		echo '<tr><td>Minimum Principal Stress </td><td>'.$pcp[6].'MPa</td></tr>';
		echo '</table>';
	}
?>