...
CREATE TABLE `student` (
  ...
  `student_whatsapp` int(10) DEFAULT NULL,
  `student_bg` int(10) DEFAULT NULL,
  `student_religion` int(10) DEFAULT NULL,
  `student_adhaar` int(16) DEFAULT NULL,
  `student_fee_category` int(10) DEFAULT NULL,
...
(1, 12, 29, 12, 0, 1, 1, '9221050001', 'manish kumar', NULL, '8427400988', 'mk7268068@gmail.com', '2004-03-12', NULL, NULL, 2147483647, NULL, NULL, 2147483647, NULL, '2021-08-19', '2021-08-19 08:36:51', 1, 0);
...
CREATE TABLE `student_address` (
  ...
  `permanent_address` varchar(10000) DEFAULT NULL,
  `correspondance_address` varchar(10000) NOT NULL,
...
INSERT INTO `student_address` (`student_id`, `permanent_address`, `correspondance_address`, `city`, `district`, `state`, `pincode`, `update_id`) VALUES
(1, 'Uttarpradesh', '', 'Ramnagar', '', '', 224181, 1);
...
(1, 'Shri Abhay Kumar', 'Shri Mati Shakuntala Devi', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-08-19 08:36:51', 1);
...
(1, 2147483647, 1, 'hello', NULL, NULL, NULL, NULL, NULL, NULL, '2021-08-19 05:48:03', 1, 0),
(7, 17, 1, 'hellomsnfdmfdfd', 'CBSE', 19333, 92, 94, 490, NULL, '2021-08-19 09:50:52', 1, 0),
(8, 33, 1, '', 'UP Board', 2019, 399, 600, 66.5, NULL, '2021-08-19 11:37:12', 1, 0),
(9, 1, 1, '', 'UP Board', 2019, 399, 600, 66.5, NULL, '2021-08-19 12:39:55', 1, 0),
(10, 0, 1, '', '', NULL, NULL, NULL, NULL, NULL, '2021-08-19 16:51:15', 1, 0);
...
CREATE TABLE `student_reference` (
  ...
  `c_staffName` varchar(100) DEFAULT NULL,
  `c_designation` varchar(100) DEFAULT NULL,
  `c_mobile` int(12) DEFAULT NULL,
  `incentive` int(100) DEFAULT NULL,
...
--
ALTER TABLE `department`
  MODIFY `dept_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `student_qualification`
  MODIFY `sq_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
