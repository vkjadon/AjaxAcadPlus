   ...
   <div class="col-10">
    <div class="tab-content" id="nav-tabContent">
     <div class="tab-pane fade show active" id="list-as" role="tabpanel" aria-labelledby="list-as-list">
      <div class="row">
       <div class="col-5 mt-1 mb-1"><button class="btn btn-secondary btn-square-sm mt-1 addStudent">Add</button>
      ...
      <div class="card shadow-sm">
       ...
       <div class="card-body">
        <div class="row-12">
         ...
         <div class="col-4">
          <p class="mb-0"><img class="profile_img" src="https://placeimg.com/640/480/arch/any" width="150px" height="150px" alt=""></p>
          <p class="mb-0"><strong class="fetchStudentName">Student Name:</strong></p>
