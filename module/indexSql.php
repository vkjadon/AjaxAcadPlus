...
if (isset($_POST['action'])) {
   if ($_POST['action'] == 'profile') {
      ...
      echo $_POST['action'];
      if ($_POST['modalId'] == 0) $sql = "insert into schedule (schedule_name, schedule_venue, schedule_date, schedule_time_from, schedule_time_to, registration_link, webinar_link, schedule_remarks, update_id, schedule_status) values('" . data_check($_POST['schedule_name']) . "', '" . data_check($_POST['schedule_venue']) . "', '" . $_POST['schedule_date'] . "', '" . $_POST['schedule_time_from'] . "', '" . $_POST['schedule_time_to'] . "', '" . $_POST['registration_link'] . "', '" . $_POST['webinar_link'] . "', '" . $_POST['schedule_remarks'] . "', '$myId', '0')";
      else $sql = "update schedule set schedule_name='" . data_check($_POST['schedule_name']) . "', schedule_venue='" . data_check($_POST['schedule_venue']) . "', schedule_date='" . $_POST['schedule_date'] . "', schedule_time_from='" . $_POST['schedule_time_from'] . "', schedule_time_to='" . $_POST['schedule_time_to'] . "', registration_link='" . $_POST['registration_link'] . "', webinar_link='" . $_POST['webinar_link'] . "', schedule_remarks='" . data_check($_POST['schedule_remarks']) . "' where schedule_id='" . $_POST['modalId'] . "'";
      $result = $conn->query($sql);
      if (!$result) echo $conn->error;
