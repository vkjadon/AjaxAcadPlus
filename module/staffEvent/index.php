    ...
    <div class="row">
      <div class="col-1 p-0 m-0 full-height">
        ...
        <div class="list-group list-group-mine mt-2" id="list-tab" role="tablist">
          <a class="list-group-item list-group-item-action lf" id="efLink" data-toggle="list" href="#list-lf" role="tab" aria-controls="lf"></a>
      ...
      <div class="col-11 leftLinkBody">
        <div class="tab-content" id="nav-tabContent">
          <div class="tab-pane show active" id="list-lf" role="tabpanel" aria-labelledby="efLink">
            <div class="row">
              <div class="col-5">
...
<script>
  $(document).ready(function() {
    ...
    $(document).on('submit', '#leaveTypeForm', function(event) {
      ...
      // $.alert(formData);
      $.post("eventSql.php", formData, () => {}, "text").done(function(mydata, mystatus) {
    ...
    $(document).on('submit', '#leaveYearForm', function() {
      ...
      $.post("eventSql.php", formData, function() {}, "text").done(function(data, success) {
        // $.alert(data)
